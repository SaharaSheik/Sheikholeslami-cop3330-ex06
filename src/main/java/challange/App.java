...
public class App {
    ...
    public static void main(String[] args) {
        ...
        int yearToretire = retireAge - age;
        if(yearToretire<0)
            System.out.println("Yay! You can already retire");
        else {
            String retirementYear = String.format("You have %d years left until you can retire.", yearToretire);
            System.out.println(retirementYear);
            String retirementDate = String.format("It's %d, so you can retire in %s", currentyear, currentyear + yearToretire);
